...
class MP_Settings {
    ...
    function admin_menu() {
        $hook = add_options_page( 'Maintenance Mode', 'Maintenance Mode', 'manage_options', 'mm_settings', array($this, 'plugin_page') );
        ...
        $settings_fields = array(
            'mp_basics' => array(
                array(
                    ...
                    'desc' => __( 'Activate the Maintenance Mode', 'maintenance-page' ),
                    'type' => 'checkbox'
                ),
                array(
                ...
                array(
                    ...
                    'desc' => __( 'Main Heading for the Maintenance Mode', 'maintenance-page' ),
                    'type' => 'text',
    ...
    function add_settings_link($links) {
        $settings_link = '<a href="options-general.php?page=mm_settings">'.__( 'Settings','maintenance-page' ).'</a>';
